...
export default function ReceptionistLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { label: "📋 Reservations",  href: "/receptionist/reservations" },
    { label: "📦 Bookings",      href: "/receptionist/bookings" },
    { label: "🛏 Rooms",         href: "/receptionist/rooms" },
    { label: "👥 Customers",     href: "/receptionist/customers" },
    { label: "🧾 Bill",          href: "/receptionist/bill" },
  ];
      ...
      <aside className="w-60 bg-white border-r border-slate-200 flex flex-col">
        <div className="p-4 border-b border-slate-200">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-xl bg-blue-600 flex items-center justify-center text-white font-bold text-sm">M</div>
            <div>
